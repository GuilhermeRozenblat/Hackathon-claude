...
| `docs/DECISOES.md` | As 22 decisões que custariam caro reverter, com o porquê |
...
**Honestidade.** O sistema **não decide quem entra**: cadastra, estima e informa status. Nunca
